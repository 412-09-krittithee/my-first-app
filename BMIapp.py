...
st.markdown("# :red[💪 คำนวณค่าดัชณีมวลกาย BMI]")
...
if st.button("คำนวณค่า BMI 🎯"):
   # แปลงสว่นจาก cm เป็น เมตร แล้วคำนวณ BMI
...
#ส่วนที่ 4 แปลผลค่า BMI ตามเกณฑ์
   if bmi < 18.5:
      st.warning("⚠️ คุณมีค่าน้ำหนักน้อยกว่าเกณฑ์ (ผอม)")
   elif 18.5 <= bmi < 23.0:
      st.success("🎉 คุณมีน้ำหนักอยู่ในเกณฑ์ปกติ (สุขภาพดี)")
   elif 23.0 <= bmi < 25.0:
      st.info("💡 คุณเริ่มมีน้ำหนักเกินเกณฑ์ (ท้วม)")
   else:
      st.error("🚨 คุณอยู่ในเกณฑ์อ้วน ควรระวังเรื่องสุขภาพและออกกกำลังกาย")
